...
{
    public class ActiveUserCommandHandler : BaseHandler, IRequestHandler<ActiveUserCommand, Unit>
    {
        private readonly UserRules _userRules;
        private readonly UserManager<User> _userManager;

        public ActiveUserCommandHandler(IMapper mapper, IUnitOfWork unitOfWork, IHttpContextAccessor httpContextAccessor, UserRules userRules, UserManager<User> userManager)
