...
{
      public class UpdateAssetMovementCommandValidator : AbstractValidator<UpdateAssetMovementCommand>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly UserManager<User> _userManager;
        public UpdateAssetMovementCommandValidator(IUnitOfWork unitOfWork, UserManager<User> userManager)
        {
